                        ...
                        <div class="col-lg-10 col-xl-7">
                            <div class="text-center">
                                ...
                                <div class="d-flex align-items-center justify-content-center">
                                    <img class="rounded-circle me-3" src="https://dummyimage.com/40x40/ced4da/6c757d" alt="..."></img>
                                    <div class="fw-bold">
                                        Tom Ato
            ...
            <div class="container px-5 my-5">
                    ...
                    <div class="row gx-5">
                        <div class="col-lg-4 mb-5">
                            ...
                            <img class="card-img-top" src="https://dummyimage.com/600x350/6c757d/343a40" alt="..."></img>
                        ...
                        <div class="d-flex align-items-center justify-content-between flex-column flex-xl-row text-center text-xl-start">
                            ...
                            <div class="ms-xl-4">
                                <div class="input-group mb-2">
                                    <input class="form-control" type="text" placeholder="Email address..." aria-label="Email address..." aria-describedby="button-newsletter"></input>
